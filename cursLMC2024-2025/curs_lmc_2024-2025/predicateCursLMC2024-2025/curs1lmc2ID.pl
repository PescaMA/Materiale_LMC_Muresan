...
testsunttoate :- setof((P,Q,R), (member(P,[false,true]), member(Q,[false,true]), member(R,[false,true]), echiv(ms(P,Q,R),md(P,Q,R))), L), length(L,SperCaSuntToateOpt), write(SperCaSuntToateOpt).
